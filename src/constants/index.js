...
const experiences = [
  ...
  {
    title: "Estágiario de T.I. | Desenvolvedor NextJs/.NET (Studying)",
    company_name: "Usebens Seguros | São José do Rio Preto",
    icon: usebens,
    iconBg: "#FFFFFF",
    date: "Fevereiro 2024 - Atualmente",
    points: [
      "Usando o método SCRUM, como desenvolvimento agilista",
      "Desenvolvendo e dando assistência de aplicações web usando NextJs e outras tecnologias",
      "Desenvolvendo sites e aplicações responsivas, escaláveis e robustas",
      "Aprendendo o desenvolvimento de software em equipe e boas práticas do mercado",
      "Aprendendo o desenvolvimento de software C# com .NET e IA com Python",
    ],
  },
